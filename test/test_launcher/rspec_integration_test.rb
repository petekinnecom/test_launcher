...
module TestLauncher
  class RspecIntegrationTest < TestCase
    ...
    def test__multiple_files__all
      TestLauncher.launch("Root1""DummyTest""Class", all: true, framework: "rspec") # don't trigger the find in *this* file
    ...
    def test__multiple_files__different_roots__all
      TestLauncher.launch("DummyTest""Class", all: true, framework: "rspec") # don't trigger the find in *this* file
